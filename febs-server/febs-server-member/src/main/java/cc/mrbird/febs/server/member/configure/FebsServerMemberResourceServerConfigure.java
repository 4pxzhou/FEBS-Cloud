package cc.mrbird.febs.server.member.configure;
...
import cc.mrbird.febs.server.member.properties.FebsServerMemberProperties;
...
public class FebsServerMemberResourceServerConfigure extends ResourceServerConfigurerAdapter {
    ...
    @Autowired
    private FebsServerMemberProperties properties;
